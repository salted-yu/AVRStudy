...
class Options():
    ...
    def add_fid_options(self):
        ...
        self.parser.add_argument('--adapted_model_path', type=str,
                                 default='./vulfix_pretrain_with_ast/outputs/checkpoint-best-bleu/pytorch_model.bin',
                                 help='the path to the adapted codet5 model')
