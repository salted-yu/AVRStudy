...
class TextDataset(Dataset):
    def __init__(self, tokenizer, args, file_type="train"):
        ...
        # for i in range(5):
            ...
            self.examples.append(
                self.convert_examples_to_features(source[i], vul_target[i], repair_target[i], tokenizer, args, languages[i]))
    ...
    def convert_examples_to_features(self, source, vul_target, repair_target, tokenizer, args, language):
